...
- **`karate-monkey-cyc-build.md`** — second bike (2026-09-17): KM XL complete (Fool’s Gold rigid, AMG, ordered) × CYC X1 Pro Gen 4 32T/53T (CYC Hong Kong, ordered: full-twist, SW102, no brake sensors). Kilo stays BBSHD. Canonical for the Monkey.
